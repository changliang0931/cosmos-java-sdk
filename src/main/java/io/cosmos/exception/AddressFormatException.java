...
public class AddressFormatException extends IllegalArgumentException {
	...
	/**
	 * This exception is thrown by {@link Bech32} hierarchy of classes when you
	 * try to decode data and a character isn't valid. You shouldn't allow the
	...
	/**
	 * This exception is thrown by {@link Bech32} hierarchy of classes when you
	 * try to decode data and the data isn't of the right size. You shouldn't
	 * allow the user to proceed in this case.
	 */
	...
	/**
	 * This exception is thrown by {@link Bech32} hierarchy of classes when you
	 * try to decode data and the checksum isn't valid. You shouldn't allow the
	 * user to proceed in this case.
	 */
	...
	/**
	 * This exception is thrown by the PrefixedChecksummedBytes hierarchy of
