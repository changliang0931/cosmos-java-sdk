...
public class LocalEnv extends EnvBase {
	...
	public String GetMainPrefix() {
		return ConstantsLocal.Bech32MainPrefix;
	};

	public String GetDenom() {
		return ConstantsLocal.COSMOS_DEFAULT_DENOM;
	}

	public String GetChainid() {
		return ConstantsLocal.COSMOS_CHAIN_ID;
	}

	public String GetRestServerUrl() {
		return ConstantsLocal.COSMOS_REST_SERVER_RRL;
	}

	public String GetHDPath() {
		return ConstantsLocal.FullFundraiserPath;
	}

	public String GetValidatorAddrPrefix() {
		return ConstantsLocal.Bech32PrefixValAddr;
	}

	public String GetAccountAddrPrefix() {
		return ConstantsLocal.Bech32PrefixAccAddr;
	}

	public String GetConsensusAddrPrefix() {
		return ConstantsLocal.Bech32PrefixConsAddr;
	}
