...
public class CommissionMsg {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("max_change_rate", this.maxChangeRate)
				.append("max_rate", this.maxRate).append("rate", this.rate).toString();
	}
}
